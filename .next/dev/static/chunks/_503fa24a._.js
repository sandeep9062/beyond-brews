...
const Navigation = ()=>{
    ...
    const { totalItems, setIsCartOpen } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
...
_s(Navigation, "4ceZSlURea40aQsX1fjzYNHTblE=", false, function() {
    return [
...
"[project]/components/WhatsAppWidget.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const WhatsAppIcon = ({ className })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
        viewBox: "0 0 24 24",
        className: className,
        fill: "currentColor",
...
const WhatsAppWidget = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WhatsAppWidget.useEffect": ()=>{
            const handleScroll = {
                "WhatsAppWidget.useEffect.handleScroll": ()=>{
                    setIsVisible(window.scrollY > 300);
                }
            }["WhatsAppWidget.useEffect.handleScroll"];
            window.addEventListener('scroll', handleScroll);
            return ({
                "WhatsAppWidget.useEffect": ()=>window.removeEventListener('scroll', handleScroll)
            })["WhatsAppWidget.useEffect"];
        }
    }["WhatsAppWidget.useEffect"], []);
        ...
        "WhatsAppWidget.useEffect": ()=>{
            if (isOpen) {
                ...
                const timer = setTimeout({
                    "WhatsAppWidget.useEffect.timer": ()=>setIsTyping(false)
                }["WhatsAppWidget.useEffect.timer"], 1500);
                return ({
...
const CartSheet = ()=>{
    _s();
    const { items, updateQuantity, removeFromCart, totalPrice, isCartOpen, setIsCartOpen } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
...
_s(CartSheet, "oqK+YQ1j9I9jg32epj2+ExC5yl4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"]
    ];
});
...
//# sourceMappingURL=_503fa24a._.js.map